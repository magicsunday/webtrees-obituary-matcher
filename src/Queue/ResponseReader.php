 ...
 * (distinct from a plain IO failure of the underlying file helper).
 *
 * The decoded response.json shape this reader validates:
 *
 *     {
...
{
    /**
     * @var int The only response schema version this reader accepts. An unknown version is rejected.
     */
