 ...
 * panel. It carries the configured base URL and a token-is-set boolean — the token VALUE never reaches
 * a view. An optional probe readout accompanies it after a reachability test; a plain GET render carries
 * none. The template escapes every sink once with e().
 *
