...
/**
 * Generic base test case that provides a unique temporary working directory under the system temp
 * dir, created in setUp and removed recursively in tearDown so each test is isolated.
 *
...
abstract class TempDirTestCase extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->tmp = sys_get_temp_dir() . '/obituary-test-' . uniqid('', true);
